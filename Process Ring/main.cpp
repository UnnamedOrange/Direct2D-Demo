...
using namespace D2DDemo::ProcessRing;
using namespace D2DDemo::ProcessRing::Window;
...
int D2DDemo::ProcessRing::Main::OnExecute()
{
	CreateD2DFactory();
